...
- **Sources** (practical examples):
  - [01.02-how_copilot_assembles_and_processes_prompts.md](https://learn-testmc-app-itn-01.azurewebsites.net/03.00-tech/05.02-prompt-engineering/03-concepts/01.02-how-copilot-assembles-and-processes-prompts) — 6-layer system prompt diagram, context rot examples, choosing the right mechanism flowchart
  - [01.03-understanding_prompt_files_instructions_and_context_layers.md](https://learn-testmc-app-itn-01.azurewebsites.net/03.00-tech/05.02-prompt-engineering/03-concepts/01.03-understanding-prompt-files-instructions-and-context-layers) — injection layer comparison, instruction combination behavior
