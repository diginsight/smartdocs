...
packages up while everything else continues to come from nuget.org.
...
$VersionProjectPath = Join-Path $RepositoryRoot 'src' 'Diginsight.SmartDocs.Web' 'Diginsight.SmartDocs.Web.csproj'
...
Write-Host ''
Write-Host 'Run: dotnet restore src/Diginsight.SmartDocs.slnx --force-evaluate'
